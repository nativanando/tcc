...
\contentsline {lstlisting}{\numberline {3}Implementa\IeC {\c c}\IeC {\~a}o da interface Empresa em Python}{44}{lstlisting.5.3}
\contentsline {lstlisting}{\numberline {4}Implementa\IeC {\c c}\IeC {\~a}o do objeto Crawler que realiza a busca das a\IeC {\c c}\IeC {\~o}es}{45}{lstlisting.5.4}
\contentsline {lstlisting}{\numberline {5}Implementa\IeC {\c c}\IeC {\~a}o da fun\IeC {\c c}\IeC {\~a}o que realiza o c\IeC {\'a}lculo da m\IeC {\'e}dia m\IeC {\'o}vel}{49}{lstlisting.5.5}
...
\contentsline {lstlisting}{\numberline {10}Constru\IeC {\c c}\IeC {\~a}o de uma RNA com a estrutura \textit {FeedForward}}{53}{lstlisting.5.10}
\contentsline {lstlisting}{\numberline {11}Implementa\IeC {\c c}\IeC {\~a}o da classe de cria\IeC {\c c}\IeC {\~a}o de camadas}{53}{lstlisting.5.11}
