...
O Código 14 expõe o desenvolvimento do método que realiza a criação da base de treino, através dos dados coletados pela biblioteca pandas, realizado anteriormente.
...
Após concluído os procedimentos anteriores, pode-se iniciar, efetivamente, o treinamento da RNA. É importante ressaltar que, neste trabalho, o treino foi executado através do algoritmo \textit{Backpropagation}. O Código 13 demostra, de forma simples, como trabalhar com o algoritmo através da biblioteca PyBrain.
