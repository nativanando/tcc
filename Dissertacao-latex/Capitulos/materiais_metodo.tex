...
Tendo em vista a especificação do modelo da rede e dos dados utilizados para realizar o treinamento e os testes, a próxima etapa foi levantar as entradas utilizadas na RNA. Como o objetivo do trabalho é realizar a predição do valor de abertura das ações em dias posteriores aos treinados, todas as váriaveis coletadas serão utilizadas como entrada da RNA. Portanto, os parâmetros que irão compor a camada de entrada da RNA são:
