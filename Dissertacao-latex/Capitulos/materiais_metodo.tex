...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=0.8\textwidth, scale=0.5]{rna-arq2}}
	\caption{Modelo de arquitetura proposto utilizando o algoritmo \textit{backpropagation}}
	\fonte{Elaborado pelo autor}
	\label{exec-rna}
\end{figure}
